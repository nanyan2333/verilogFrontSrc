...
import { Link, useNavigate } from 'react-router-dom'; // useNavigate 用于返回上一页
import '../assets/style/NoPermission.css'; // 对应的 CSS 文件
    ...
    <div className="no-permission-container">
      <div className="no-permission-content">
        ...
        <div className="buttons-container-np">
          <button onClick={handleGoBack} className="action-button-np go-back-button-np">
            返回上一页
          </button>
        </div>
      </div>
